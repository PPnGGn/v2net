...
class VpnConfigMessage {
  VpnConfigMessage({required this.configJson, this.serverId, this.title});
  ...
  List<Object?> _toList() {
    return <Object?>[configJson, serverId, title];
  }
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(configJson, other.configJson) &&
        _deepEquals(serverId, other.serverId) &&
...
class VpnStatusMessage {
  VpnStatusMessage({required this.status, this.error, this.connectedAtEpochMs});
  ...
  List<Object?> _toList() {
    return <Object?>[status, error, connectedAtEpochMs];
  }
  ...
  static VpnStatusMessage decode(Object result) {
    ...
    return VpnStatusMessage(
      ...
      connectedAtEpochMs: result[2] as int?,
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(status, other.status) &&
        ...
        _deepEquals(connectedAtEpochMs, other.connectedAtEpochMs);
  }
...
class VpnLogMessage {
  ...
  List<Object?> _toList() {
    return <Object?>[level, message, source, timestampMs];
  }
...
class VpnTrafficMessage {
  VpnTrafficMessage({required this.uplinkBytes, required this.downlinkBytes});
  ...
  List<Object?> _toList() {
    return <Object?>[uplinkBytes, downlinkBytes];
  }
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(uplinkBytes, other.uplinkBytes) &&
        _deepEquals(downlinkBytes, other.downlinkBytes);
  }
...
class VpnResult {
  VpnResult({required this.successful, this.error});
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(successful, other.successful) &&
        _deepEquals(error, other.error);
  }
...
class VpnConnection {
  ...
  Future<VpnResult> start(VpnConfigMessage config) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.v2net.VpnConnection.start$pigeonVar_messageChannelSuffix';
  ...
  Future<VpnResult> stop() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.v2net.VpnConnection.stop$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<VpnStatusMessage> getStatus() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.v2net.VpnConnection.getStatus$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
...
abstract class VpnEventReceiver {
  ...
  static void setUp(
    ...
    {
      final pigeonVar_channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.v2net.VpnEventReceiver.onStatusChanged$messageChannelSuffix',
        pigeonChannelCodec,
        binaryMessenger: binaryMessenger,
      );
      if (api == null) {
    ...
    {
      final pigeonVar_channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.v2net.VpnEventReceiver.onLog$messageChannelSuffix',
        pigeonChannelCodec,
        binaryMessenger: binaryMessenger,
      );
      if (api == null) {
    ...
    {
      final pigeonVar_channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.v2net.VpnEventReceiver.onTraffic$messageChannelSuffix',
        pigeonChannelCodec,
        binaryMessenger: binaryMessenger,
      );
      if (api == null) {
